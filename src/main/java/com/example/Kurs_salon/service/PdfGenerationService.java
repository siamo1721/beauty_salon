...
public class PdfGenerationService {
    ...
    public byte[] generateProceduresReport(LocalDateTime startDate, LocalDateTime endDate) {
        ...
        try {
            ...
            table.addCell(createCell("Рейтинг", TITLE_FONT));
            ...
            for (Appointment appointment : appointments) {
                ...
                if (!reviews.isEmpty()) {
                    ...
                    String ratingString = reviews.stream()
                            .map(review -> review.getRating().toString())
                            .collect(Collectors.joining(", "));
                    table.addCell(createCell(ratingString, NORMAL_FONT));
                } else {
                    table.addCell(createCell("Нет отзыва", NORMAL_FONT));
                    table.addCell(createCell("Нет рейтинга", NORMAL_FONT));
                }
            }
